...
void tb::sink() {
    ...
    // print latency
    double total_throughput = (start_time[63].to_double() - start_time[0].to_double()) / clock_period.to_double();
    printf("Average Latency: %g cycles\n", (double)total_cycles/64);
    printf("Average Throughput: %g per clock cycle\n", (double)total_throughput/63);
